...
sub jobMinimap2Grid($$$$$$$$) {
    my ($pl, $name, $target, $query, $options, $blockSize, $overlap, $workDir) = @_;
...
sub jobRaconGrid($$$$$$$$$) {
    my ($pl, $name, $contigs, $reads, $rd2ctg, $options, $blockSize, $polished, $workDir) = @_;
...
sub jobPolishWithMinimap2Racon($$$$$$$$) {
    my ($pl, $name, $contigs, $reads, $polished, $options, $blockSize, $workDir) = @_;
    ...
    my $jobMapContigs = jobMinimap2Grid($pl, "${name}_map", $contigs, $reads, 
            $options->[0], $blockSize->[0], $rd2ctg, $workDir);
    my $jobPolishContigs = jobRaconGrid($pl, $name, $contigs, $reads, $rd2ctg, 
